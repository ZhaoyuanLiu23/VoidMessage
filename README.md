...
- **兴趣**：星座、塔罗、MBTI、明星、旅游、摄影
- **科技**：机器人、芯片、人工智能、天体物理、量子力学、理论探究
- **艺术**：音乐、绘画、舞蹈、电影、设计、文学
- **学习**：数学、雅思、四六级、编程、物理、化学
- **游戏**：原神、王者荣耀、三角洲、我的世界、英雄联盟、Steam
...
| **GET** | **/api/auth/me** | 返回当前匿名颜色身份 |
| **GET** | **/api/messages?room=...&after=...** | 首次或增量获取房间消息 |
...
默认访问 **http://localhost:3000**。生产构建与本地预览：
